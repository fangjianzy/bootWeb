...
public class RoleServiceImpl implements RoleService {
    ...
    public RoleDO get(Long id) {
        ...
        List<MenuDO> menus = menuDao.findByRoleId(id);
        roleDO.setMenus(menus);
        return roleDO;
    }
